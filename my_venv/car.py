...
def main():
    ...
    file_path = "../resource/car.csv"  # Replace with the path to your CSV file
    selected_columns = ["Make", "Model", "Vehicle Class", "Fuel Consumption Comb (L/100 km)", "CO2 Emissions(g/km)"]
