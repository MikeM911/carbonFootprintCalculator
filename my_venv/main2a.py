...
def submit():
    try:
        ...
        # Check if Year and Household size are selected
        ...
        if not selected_data.empty:
            ...
            # Clear the total label when data is not available
...
root.geometry("500x650")  # Adjust the width and height as needed
...
# Create an entry field for household size
